...
parser.add_argument('--model_name', required=True)#DAGTransformer, CNN, LSTM, VanillaTransformer
parser.add_argument('--split', default='split6_2_2')
opt = parser.parse_args()

if opt.model_name !='DAGTransformer' and opt.model_name !='CNN' and opt.model_name !='LSTM' and opt.model_name !='VanillaTransformer':
    raise AssertionError('model should be DAGTransformer/CNN/LSTM/VanillaTransformer')
